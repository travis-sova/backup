...
CREATE TABLE `storeemployees` (
  ...
  KEY `StoreEmployees_employeeId_fkey` (`employeeId`),
  CONSTRAINT `StoreEmployees_employeeId_fkey` FOREIGN KEY (`employeeId`) REFERENCES `employee` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `StoreEmployees_storeId_fkey` FOREIGN KEY (`storeId`) REFERENCES `store` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2023-11-27 10:12:12
